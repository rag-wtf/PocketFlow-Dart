...
/// A flow that processes a batch of items by executing a set of nodes in
/// parallel for each item.
///
/// `ParallelNodeBatchFlow` is useful for scenarios where multiple independent
/// operations need to be performed on each item in a batch. For each item, the
/// flow triggers all nodes concurrently and waits for them to complete.
